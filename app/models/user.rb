class User < ApplicationRecord
  ...
  validates :password, presence: true, length: { minimum: 8 },allow_nil: true, format: PASSWORD_REQUERIMENTS
    ...
    # Returns a user's status feed, using left_outer_join
    #Pasa el test pero trae repetidamente el ultimo post del current_user. Para evitar eso tenemos que agregar distinct al where
    def feed
    ...
    # Returns true if the currente user is following the other user
